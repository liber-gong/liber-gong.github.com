...
Project Name：A project of an industry top 10 company  
Responsibility：As a senior front-end engineer, in charge of migrate a project to AWS Lambda + SSR architecture.  
Description: Rewrite the project using the new architecture, apply the best practice of a front-end project: performance + SEO + cost.

Project Name：A web3 social network telegram mini program  
Responsibility：In charge of the telegram project line of business  
Description: Work along with the product manager on a telegram mini program, to boost the increase of the business.
...
- 2024.11 - 2024.12, An industry top 10 company, Senior front-end Engineer
- 2024.08 - 2024.10, A Web3 social network, Senior front-end Engineer
- 2022.09 - 2024-05, Wondervoy, LLM prompt engineer, Full-stack Engineer
...
Description of the Wondervoy company: Wondervoy is an AI-based solution startup. The main business of the company focus on hotels. Official website: [https://wondervoy.com/](https://wondervoy.com/)  
...
[https://github.com/liber-gong/dapp](https://github.com/liber-gong/dapp)
...
[https://github.com/liber-gong/react-chatgpt](https://github.com/liber-gong/react-chatgpt)
